...
<!-- ============================================-->
      <!-- <section> begin ============================-->
        <section class="pb-4 pt-1 bg-600">

            <div class="container">
              <div class="row">
                <div class="col-12">
                  <h1 class="mb-2">Zoznam petícií</h1>
                    ...
                    <div class="col-md-4 mb-4">
                      ...
                      <div class="card btn-outline-primary border-start-0 border-top-0 border-5 h-100 rounded-0">
                            ...
                            <div class="card-header pt-2 pb-1 rounded-0">
                                <h5 class="font-sans-serif fw-bold fs-md-1 fs-sm-0 fs-lg-2 fs-xl-2 lh-1">{{ $row->title }}</h5>
                            </div></div>
                            ...
                            <img class="card-img-top w-100 h-100 rounded-0 mx-auto"  src="{{ asset('backend_user\assets\img\gallerymy\peticia-dav.png')}}"alt="PETICIA BEZ OBRÁZKA" />
                            </div>
                            @else
                            <img class="card-img-top w-100 h-100  rounded-0 mx-auto" src="{{ asset($row->image)}}" alt="PETICIA OBRÁZOK" />
                            @endempty
